                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              AppText(text: detail.places.location, color: AppColors.mainTextColor)
                            ],
                          ),
                          SizedBox(
                            height: 20,
                          ...
                          Row(
                            children: [
                              Wrap(
                                  children: List.generate(5, (index) => Icon(Icons.star, color: detail.places.stars>index?AppColors.starColor: AppColors.textColor2,))
                              ),
                              SizedBox(
                                width: 10,
                              ),
